...
git clone --recursive https://github.com/JJTech0130/MultiMC5.git src
...
2. Once that is open, change into your user directory, and clone MultiMC by doing `git clone --recursive https://github.com/JJTech0130/MultiMC5.git`, and change directory to the folder you cloned to.
...
```
git clone --recursive https://github.com/JJTech0130/MultiMC5.git
cd MultiMC5
mkdir build
cd build
cmake \
